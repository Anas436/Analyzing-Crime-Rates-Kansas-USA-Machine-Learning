...
@st.cache_data
def load_data():
    crime_data = pd.read_csv('https://raw.githubusercontent.com/OmdenaAI/kansas-chapter-crime-rates/main/src/city_of_kansas_app/final_data.csv?token=GHSAT0AAAAAACGTWO45XVFK6VPVRXWVBBZEZHJGAOQ')
    return crime_data
...
image = Image.open('https://github.com/OmdenaAI/kansas-chapter-crime-rates/blob/main/src/city_of_kansas_app/Flag_of_Kansas.png')
